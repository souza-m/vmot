...
evo_b1 = -np.array(D_evo1_minus[:100]) # random, independent
evo_b2 = -np.array(D_evo2_minus[:100]) # random, monotone
labels = ['full', 'reduced']
...
pl.axhline(sample_mean_cost, linestyle=':', color='grey')
