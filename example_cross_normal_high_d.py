...
def convergence_plot(value_series_list, labels, ref_value = None, ref_color = 'black', h_series_list = None):
    ...
    # pl.xlabel('epoch')
    pl.title('Numerical value - convergence')
    pl.show()
...
for i in range(existing_i+1, I+1):
    ...
    convergence_plot([evo2, evo1], ['monotone', 'independent'], ref_value, h_series_list=[h2, h1])
