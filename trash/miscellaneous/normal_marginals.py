...
# batch control
I = 200            # total desired iterations
existing_i = 7    # last iteration saved
...
if existing_i == 0:
    ...
    # train
    D_evo1, H_evo1, P_evo1, ds_evo1, hs_evo1 = vmot.mtg_train(ws1, model1, d, nperiods, monotone = False, opt_parameters=opt_parameters, verbose = 10)
    D_evo2, H_evo2, P_evo2, ds_evo2, hs_evo2 = vmot.mtg_train(ws2, model2, d, nperiods, monotone = True,  opt_parameters=opt_parameters, verbose = 10)
