...
for example in [1, 2]:
    if example == 1:
        cost = cost_f
        label = 'empirical_return'
    if example == 2:
        cost = minus_cost_f
        label = 'minus_empirical_return'
    print(label)
    I = 42           # number of desired iterations
    existing_i = 40
    np.random.seed(1)
...
label, label_mono = 'empirical_return_40', 'empirical_return_mono_40'
minus_label, minus_label_mono = 'minus_empirical_return_40', 'minus_empirical_return_mono_40'
# ws1, xyset1 = vmot.generate_working_sample_uv(uvset1, empirical_inv_cum_xi, empirical_inv_cum_yi, cost_f)
# ws2, xyset2 = vmot.generate_working_sample_uv_mono(uvset2, empirical_inv_cum_x, empirical_inv_cum_yi, cost_f)
...
# existing_i=10
a_, D_evo1_minus, _, __, ___, ____ = vmot.load_results(minus_label)
b_, D_evo2_minus, _, __, ___, ____ = vmot.load_results(minus_label_mono)
